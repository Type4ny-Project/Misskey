...
export class NonCascadingPageEyeCatching1756062689648 {
    ...
    async up(queryRunner) {
        await queryRunner.query(`
            UPDATE "page"
            SET "eyeCatchingImageId" = NULL
            WHERE "eyeCatchingImageId" IS NOT NULL
              AND "eyeCatchingImageId" NOT IN (SELECT "id" FROM "drive_file")
        `);

        await queryRunner.query(`ALTER TABLE "page" DROP CONSTRAINT IF EXISTS "FK_a9ca79ad939bf06066b81c9d3aa"`);
