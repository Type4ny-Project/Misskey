...
export const DI = {
	...
	hashtagFollowingsRepository: Symbol('hashtagFollowingsRepository'),
	...
	callsRoomsRepository: Symbol('callsRoomsRepository'),
	callsParticipantsRepository: Symbol('callsParticipantsRepository'),
	callsModerationLogsRepository: Symbol('callsModerationLogsRepository'),
