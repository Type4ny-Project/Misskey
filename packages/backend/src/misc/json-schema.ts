...
import { packedCallsParticipantSchema, packedCallsRoomSchema } from '@/models/json-schema/calls-room.js';
...
export const refs = {
	...
	CallsRoom: packedCallsRoomSchema,
	CallsParticipant: packedCallsParticipantSchema,
};
