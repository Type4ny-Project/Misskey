...
export * as 'i/logout' from './endpoints/i/logout.js';
...
export * as 'calls/media/renegotiate' from './endpoints/calls/media/renegotiate.js';
export * as 'calls/media/tracks/close' from './endpoints/calls/media/close.js';
