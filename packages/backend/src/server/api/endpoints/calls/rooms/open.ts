...
export default class extends Endpoint<typeof meta, typeof paramDef> { // eslint-disable-line import/no-default-export
	constructor(service: CallsRoomService, entity: CallsEntityService) { super(meta, paramDef, async (ps, me) => { try { return entity.packRoom(await service.open(me, ps.roomId, ps.expectedRevision)); } catch (error) { callsApiError(error); } }); }
}
