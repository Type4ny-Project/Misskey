...
declare module '../api.js' {
  export interface APIClient {
     ...
     * **Credential required**: *Yes* / **Permission**: *write:admin:account*
     */
    request<E extends 'admin/accounts/revoke-points', P extends Endpoints[E]['req']>(
      endpoint: E,
      params: P,
      credential?: string | null,
    ): Promise<SwitchCaseResponseType<E, P>>;
     ...
     */
    request<E extends 'admin/emoji/approve-request', P extends Endpoints[E]['req']>(
      endpoint: E,
      params: P,
      credential?: string | null,
    ): Promise<SwitchCaseResponseType<E, P>>;
     ...
     * **Credential required**: *Yes*
     */
    request<E extends 'admin/emoji/reject-request', P extends Endpoints[E]['req']>(
      endpoint: E,
      params: P,
      credential?: string | null,
    ): Promise<SwitchCaseResponseType<E, P>>;
     ...
     * **Credential required**: *Yes*
     */
    request<E extends 'admin/emoji/request-settings', P extends Endpoints[E]['req']>(
      endpoint: E,
      params: P,
      credential?: string | null,
    ): Promise<SwitchCaseResponseType<E, P>>;
     ...
     * **Credential required**: *Yes*
     */
    request<E extends 'admin/emoji/update-request-settings', P extends Endpoints[E]['req']>(
      endpoint: E,
      params: P,
      credential?: string | null,
    ): Promise<SwitchCaseResponseType<E, P>>;
     ...
     */
    request<E extends 'admin/events/list', P extends Endpoints[E]['req']>(
      endpoint: E,
      params: P,
      credential?: string | null,
    ): Promise<SwitchCaseResponseType<E, P>>;
     ...
     * **Credential required**: *No*
     */
    request<E extends 'calls/capabilities', P extends Endpoints[E]['req']>(
      endpoint: E,
      params: P,
      credential?: string | null,
    ): Promise<SwitchCaseResponseType<E, P>>;
     ...
     */
    request<E extends 'calls/media/credential/refresh', P extends Endpoints[E]['req']>(
      endpoint: E,
      params: P,
      credential?: string | null,
    ): Promise<SwitchCaseResponseType<E, P>>;
     ...
     */
    request<E extends 'calls/media/reconcile', P extends Endpoints[E]['req']>(
      endpoint: E,
      params: P,
      credential?: string | null,
    ): Promise<SwitchCaseResponseType<E, P>>;
     ...
     * **Credential required**: *Yes* / **Permission**: *write:calls*
     */
    request<E extends 'calls/media/renegotiate', P extends Endpoints[E]['req']>(
      endpoint: E,
      params: P,
      credential?: string | null,
    ): Promise<SwitchCaseResponseType<E, P>>;
     ...
     * **Credential required**: *Yes* / **Permission**: *write:calls*
     */
    request<E extends 'calls/media/session/create', P extends Endpoints[E]['req']>(
      endpoint: E,
      params: P,
      credential?: string | null,
    ): Promise<SwitchCaseResponseType<E, P>>;
     ...
     * **Credential required**: *Yes* / **Permission**: *write:calls*
     */
    request<E extends 'calls/media/tracks/close', P extends Endpoints[E]['req']>(
      endpoint: E,
      params: P,
      credential?: string | null,
    ): Promise<SwitchCaseResponseType<E, P>>;
     ...
     * **Credential required**: *Yes* / **Permission**: *write:calls*
     */
    request<E extends 'calls/media/tracks/publish', P extends Endpoints[E]['req']>(
      endpoint: E,
      params: P,
      credential?: string | null,
    ): Promise<SwitchCaseResponseType<E, P>>;
     ...
     * **Credential required**: *Yes* / **Permission**: *write:calls*
     */
    request<E extends 'calls/media/tracks/subscribe', P extends Endpoints[E]['req']>(
      endpoint: E,
      params: P,
      credential?: string | null,
    ): Promise<SwitchCaseResponseType<E, P>>;
     ...
     * **Credential required**: *Yes* / **Permission**: *write:calls*
     */
    request<E extends 'calls/media/turn-credentials', P extends Endpoints[E]['req']>(
      endpoint: E,
      params: P,
      credential?: string | null,
    ): Promise<SwitchCaseResponseType<E, P>>;
     ...
     * **Credential required**: *Yes* / **Permission**: *write:calls*
     */
    request<E extends 'calls/rooms/cancel', P extends Endpoints[E]['req']>(
      endpoint: E,
      params: P,
      credential?: string | null,
    ): Promise<SwitchCaseResponseType<E, P>>;
     ...
     * **Credential required**: *Yes* / **Permission**: *write:calls*
     */
    request<E extends 'calls/rooms/end', P extends Endpoints[E]['req']>(
      endpoint: E,
      params: P,
      credential?: string | null,
    ): Promise<SwitchCaseResponseType<E, P>>;
     ...
     * **Credential required**: *Yes* / **Permission**: *write:calls*
     */
    request<E extends 'calls/rooms/join', P extends Endpoints[E]['req']>(
      endpoint: E,
      params: P,
      credential?: string | null,
    ): Promise<SwitchCaseResponseType<E, P>>;
     ...
     * **Credential required**: *Yes* / **Permission**: *write:calls*
     */
    request<E extends 'calls/rooms/leave', P extends Endpoints[E]['req']>(
      endpoint: E,
      params: P,
      credential?: string | null,
    ): Promise<SwitchCaseResponseType<E, P>>;
     ...
     * **Credential required**: *Yes* / **Permission**: *read:calls*
     */
    request<E extends 'calls/rooms/list', P extends Endpoints[E]['req']>(
      endpoint: E,
      params: P,
      credential?: string | null,
    ): Promise<SwitchCaseResponseType<E, P>>;
     ...
     * **Credential required**: *Yes* / **Permission**: *write:calls*
     */
    request<E extends 'calls/rooms/request-speaker', P extends Endpoints[E]['req']>(
      endpoint: E,
      params: P,
      credential?: string | null,
    ): Promise<SwitchCaseResponseType<E, P>>;
     ...
     * **Credential required**: *Yes* / **Permission**: *write:drive*
     */
    request<E extends 'emoji-request/create', P extends Endpoints[E]['req']>(
      endpoint: E,
      params: P,
      credential?: string | null,
    ): Promise<SwitchCaseResponseType<E, P>>;
     ...
     * **Credential required**: *Yes* / **Permission**: *write:account*
     */
    request<E extends 'events/approve', P extends Endpoints[E]['req']>(
      endpoint: E,
      params: P,
      credential?: string | null,
    ): Promise<SwitchCaseResponseType<E, P>>;
     ...
     * **Credential required**: *Yes* / **Permission**: *write:account*
     */
    request<E extends 'events/create', P extends Endpoints[E]['req']>(
      endpoint: E,
      params: P,
      credential?: string | null,
    ): Promise<SwitchCaseResponseType<E, P>>;
     ...
     * **Credential required**: *Yes* / **Permission**: *write:account*
     */
    request<E extends 'events/delete', P extends Endpoints[E]['req']>(
      endpoint: E,
      params: P,
      credential?: string | null,
    ): Promise<SwitchCaseResponseType<E, P>>;
     ...
     * **Credential required**: *No* / **Permission**: *read:account*
     */
    request<E extends 'events/list', P extends Endpoints[E]['req']>(
      endpoint: E,
      params: P,
      credential?: string | null,
    ): Promise<SwitchCaseResponseType<E, P>>;
     ...
     * **Credential required**: *Yes* / **Permission**: *read:account*
     */
    request<E extends 'events/my-submissions', P extends Endpoints[E]['req']>(
      endpoint: E,
      params: P,
      credential?: string | null,
    ): Promise<SwitchCaseResponseType<E, P>>;
     ...
     * **Credential required**: *Yes* / **Permission**: *read:account*
     */
    request<E extends 'events/pending', P extends Endpoints[E]['req']>(
      endpoint: E,
      params: P,
      credential?: string | null,
    ): Promise<SwitchCaseResponseType<E, P>>;
     ...
     * **Credential required**: *Yes* / **Permission**: *write:account*
     */
    request<E extends 'events/reject', P extends Endpoints[E]['req']>(
      endpoint: E,
      params: P,
      credential?: string | null,
    ): Promise<SwitchCaseResponseType<E, P>>;
     ...
     * **Credential required**: *No* / **Permission**: *read:account*
     */
    request<E extends 'events/show', P extends Endpoints[E]['req']>(
      endpoint: E,
      params: P,
      credential?: string | null,
    ): Promise<SwitchCaseResponseType<E, P>>;
     ...
     * **Credential required**: *Yes* / **Permission**: *write:account*
     */
    request<E extends 'events/update', P extends Endpoints[E]['req']>(
      endpoint: E,
      params: P,
      credential?: string | null,
    ): Promise<SwitchCaseResponseType<E, P>>;
     ...
     * **Credential required**: *Yes* / **Permission**: *write:account*
     */
    request<E extends 'hashtags/follow', P extends Endpoints[E]['req']>(
      endpoint: E,
      params: P,
      credential?: string | null,
    ): Promise<SwitchCaseResponseType<E, P>>;
     ...
     * **Credential required**: *Yes* / **Permission**: *read:account*
     */
    request<E extends 'hashtags/followed', P extends Endpoints[E]['req']>(
      endpoint: E,
      params: P,
      credential?: string | null,
    ): Promise<SwitchCaseResponseType<E, P>>;
     ...
     * **Credential required**: *Yes* / **Permission**: *read:account*
     */
    request<E extends 'hashtags/is-following', P extends Endpoints[E]['req']>(
      endpoint: E,
      params: P,
      credential?: string | null,
    ): Promise<SwitchCaseResponseType<E, P>>;
     ...
     * **Credential required**: *Yes* / **Permission**: *write:account*
     */
    request<E extends 'hashtags/unfollow', P extends Endpoints[E]['req']>(
      endpoint: E,
      params: P,
      credential?: string | null,
    ): Promise<SwitchCaseResponseType<E, P>>;
     ...
     * **Credential required**: *Yes*
     */
    request<E extends 'i/logout', P extends Endpoints[E]['req']>(
      endpoint: E,
      params: P,
      credential?: string | null,
    ): Promise<SwitchCaseResponseType<E, P>>;
     ...
     * **Credential required**: *Yes* / **Permission**: *read:account*
     */
    request<E extends 'i/weekly-stats', P extends Endpoints[E]['req']>(
      endpoint: E,
      params: P,
      credential?: string | null,
    ): Promise<SwitchCaseResponseType<E, P>>;
     ...
     * **Credential required**: *Yes* / **Permission**: *read:account*
     */
    request<E extends 'notes/reactions/suggestions', P extends Endpoints[E]['req']>(
      endpoint: E,
      params: P,
      credential?: string | null,
    ): Promise<SwitchCaseResponseType<E, P>>;
