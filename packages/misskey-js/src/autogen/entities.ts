...
export type ChannelsFollowResponse = operations['channels___follow']['responses']['200']['content']['application/json'];
export type ChannelsFollowRequestsApproveRequest = operations['channels___follow-requests___approve']['requestBody']['content']['application/json'];
export type ChannelsFollowRequestsListRequest = operations['channels___follow-requests___list']['requestBody']['content']['application/json'];
export type ChannelsFollowRequestsListResponse = operations['channels___follow-requests___list']['responses']['200']['content']['application/json'];
export type ChannelsFollowRequestsRejectRequest = operations['channels___follow-requests___reject']['requestBody']['content']['application/json'];
...
export type ChannelsFollowersRemoveRequest = operations['channels___followers___remove']['requestBody']['content']['application/json'];
